...
import kotlinx.android.synthetic.main.rv_horizontal_cell.view.*

/*
 * -----------------------------------------------------------------
 * Copyright (C) 2018-2028, by Victor, All rights reserved.
 * -----------------------------------------------------------------
 * File: HorizontalContentHolder
 * Author: Victor
...
class HorizontalContentHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
